...
out = str(pathlib.Path(__file__).resolve().parent.parent / "wz_region_colour_identity.pdf")
with sync_playwright() as p:
    ...
    pg.goto("file://" + str(pathlib.Path(__file__).resolve().parent / "document_nt.html"))
