...
out = str(pathlib.Path(__file__).resolve().parent.parent / "contraction_and_final_cross_section.pdf")
with sync_playwright() as p:
    ...
    pg.goto("file://" + str(pathlib.Path(__file__).resolve().parent / "document_ob.html"))
