...
out = str(pathlib.Path(__file__).resolve().parent.parent / "running_coupling_row_completed.pdf")
with sync_playwright() as p:
    ...
    pg.goto("file://" + str(pathlib.Path(__file__).resolve().parent / "document_oe.html"))
