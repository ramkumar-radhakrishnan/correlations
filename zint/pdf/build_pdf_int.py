...
out = str(pathlib.Path(__file__).resolve().parent.parent / "UV_projected_row_integrated.pdf")
with sync_playwright() as p:
    ...
    pg.goto("file://" + str(pathlib.Path(__file__).resolve().parent / "document_int.html"))
