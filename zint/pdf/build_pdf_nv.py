...
out = str(pathlib.Path(__file__).resolve().parent.parent / "B2_squared_expanded_check.pdf")
with sync_playwright() as p:
    ...
    pg.goto("file://" + str(pathlib.Path(__file__).resolve().parent / "document_nv.html"))
