...
out = str(pathlib.Path(__file__).resolve().parent.parent / "rowIV_plus_prescription_steps.pdf")
with sync_playwright() as p:
    ...
    pg.goto("file://" + str(pathlib.Path(__file__).resolve().parent / "document_oj.html"))
