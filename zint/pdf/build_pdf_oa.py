...
out = str(pathlib.Path(__file__).resolve().parent.parent / "master_z_integral_tutorial.pdf")
with sync_playwright() as p:
    ...
    pg.goto("file://" + str(pathlib.Path(__file__).resolve().parent / "document_oa.html"))
