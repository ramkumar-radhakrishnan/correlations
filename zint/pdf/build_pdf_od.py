...
out = str(pathlib.Path(__file__).resolve().parent.parent / "z_integration_first_final.pdf")
with sync_playwright() as p:
    ...
    pg.goto("file://" + str(pathlib.Path(__file__).resolve().parent / "document_od.html"))
