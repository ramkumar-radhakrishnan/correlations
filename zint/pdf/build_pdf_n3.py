...
out = str(pathlib.Path(__file__).resolve().parent.parent / "four_kernel_row_divergences.pdf")
with sync_playwright() as p:
    ...
    pg.goto("file://" + str(pathlib.Path(__file__).resolve().parent / "document_n3.html"))
