...
out = str(pathlib.Path(__file__).resolve().parent.parent / "B2_row_transverse_divergences.pdf")
with sync_playwright() as p:
    ...
    pg.goto("file://" + str(pathlib.Path(__file__).resolve().parent / "document_nx.html"))
