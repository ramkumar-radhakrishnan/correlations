...
out = str(pathlib.Path(__file__).resolve().parent.parent / "rapidity_term_and_kernel.pdf")
with sync_playwright() as p:
    ...
    pg.goto("file://" + str(pathlib.Path(__file__).resolve().parent / "document_ny.html"))
